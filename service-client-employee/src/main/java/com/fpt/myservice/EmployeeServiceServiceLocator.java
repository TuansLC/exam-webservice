...
public class EmployeeServiceServiceLocator extends org.apache.axis.client.Service implements com.fpt.myservice.EmployeeServiceService {
    ...
    public com.fpt.myservice.EmployeeService getEmployeeServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.fpt.myservice.EmployeeServicePortBindingStub _stub = new com.fpt.myservice.EmployeeServicePortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.fpt.myservice.EmployeeService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.fpt.myservice.EmployeeServicePortBindingStub _stub = new com.fpt.myservice.EmployeeServicePortBindingStub(new java.net.URL(EmployeeServicePort_address), this);
                _stub.setPortName(getEmployeeServicePortWSDDServiceName());
                return _stub;
            }
        }
